    ...
    while True:
        try:
            ...
            if b == 0:
                ...
                batch_gt_masks = np.zeros((batch_size, gt_masks.shape[1], gt_masks.shape[1],
            ...
            if gt_boxes.shape[0] > config.MAX_GT_INSTANCE:
...
def build_rpn_targets(image_shape, anchors, gt_class_ids, gt_boxes, config):
    ...
    if crowd_ix.shape[0] > 0:
        ...
        np_crowd_bool = (crowd_iou_max < 0.001)
    else:
        # All anchors don't intersect a crowd
        non_crowd_bool = np.ones([anchors.shape[0]], dtype=bool)
    ...
    rpn_match[(anchor_iou_max < 0.3) & (non_crowd_bool)] = -1
...
############################################################
#  Detection targets if not used RPN
############################################################
